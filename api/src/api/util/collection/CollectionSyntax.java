...
/*
 컬렉션 프레임워크 (Collection) - 정형화된 틀
 다수의 데이터를 쉽게 처리할 수 있는 표준화된 방법을 제공하는 클래스들.
 - 3가지 타입으로 기능을 요약하고 3개의 인터페이스 List, Set, Map으로 
 - 나누어 구현함. 
...
/*
 ...
 - 다양한 객체들의 삽입, 삭제, 검색등을 위한 관리가 편한다.
 */
/*
 인터페이스 종류
...
/*
 ...
 Set entrySet() // javascript에서 JSON 과 같은 기능, Map에서 키+밸류 형태로 반환.
