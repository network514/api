...
/*
 Thread
 - 반복적으로 동기화하여 실해오디는 프로그램의 루틴 (루틴 : 비슷한 말로 함수)
 - 메소드 단위의 처리 모듈. Process의 구성요소
 - Thread는 많이 발생해도 자원을 공유함으로써 Process에 비해
 	시스템에 부담이 적음.
 */
/*
 스레드를 구현하는 방법
...
/*
 ...
 - sleep(long second) : 지정된 시간동안 스레드를 쉬게 하고, 그 시간이 지나면 다시 작동된다. 1000분의 1초
 ...
 * 교착상태(Dead lock)
 ...
 - 프로그래머는 변수와 while문 if문을 사용해서 스레드를 제어해야 함.
 */
